...
class PendingLoanApplications extends StatefulWidget {
  const PendingLoanApplications({Key? key}) : super(key: key);

  @override
  State<PendingLoanApplications> createState() => _PendingLoanApplicationsState();
}

class _PendingLoanApplicationsState extends State<PendingLoanApplications> {
      ...
      builder: (context, snapshot){
        ...
        if(snapshot.hasData){
          ...
          if(loanApplications.isEmpty){
            return const Text('এই মুহুর্তে কোনো অমীমাংসিত ঋণ আবেদন নেই।');
          }
          return SingleChildScrollView(
            child: Column(
              children: [
                const Text(
                  'অমীমাংসিত ঋণ আবেদনসমূহ',
                  style: TextStyle(
                    fontSize: 20.0,
                ...
                const Text(
                  'ঋণপ্রার্থী যে ঋণ আগে নিতে চাচ্ছেন, সেটি আগে আছে।',
                  style: TextStyle(
                    fontSize: 12.0,
                  ),
                ),
      ...
      contentChild: Column(
        children: [
          ElevatedButton(
            ...
            child: const Text('আবেদন না-মঞ্জুর ও ডিলিট করুন'),
            onPressed: () async {
              ...
              if(response){
                application.reference.delete().then((value) async {
                  ...
                  await showInformDialog(context, 'ব্যর্থ', 'আবেদন/ঋণের তথ্য ডিলিট হয়নি। ইন্টারনেট সংযোগ চেক করে পরে চেষ্টা করুন।');
                });
              }
            },
          ),
          ...
          ElevatedButton(
            ...
            child: const Text('আবেদন মঞ্জুর করুন'),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
